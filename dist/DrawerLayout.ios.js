...
DrawerLayout = (_class = (_temp = _class2 = function (_React$Component) {_inherits(DrawerLayout, _React$Component);
  ...
  function DrawerLayout(props, context) {_classCallCheck(this, DrawerLayout);var _this = _possibleConstructorReturn(this, (DrawerLayout.__proto__ || Object.getPrototypeOf(DrawerLayout)).call(this,
    ...
    {var _state =
      ...
      this.state;var drawerShown = _state.drawerShown;var openValue = _state.openValue;var _props =





      this.props;var drawerBackgroundColor = _props.drawerBackgroundColor;var drawerPosition = _props.drawerPosition;var drawerWidth = _props.drawerWidth;
      ...
      return (
        _react2.default.createElement(View, _extends({ testID: 'rootDrawer', style: { flex: 1, backgroundColor: 'transparent' } }, this._panResponder.panHandlers),
